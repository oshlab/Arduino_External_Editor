...
ace.define("ace/mode/arduino_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], function(require, exports, module) {
    ...
    var arduinoHighlightRules = function() {
        ...
        var keywordMapper = this.$keywords = this.createKeywordMapper({
            ...
            "keyword.arduinoop":arduinoOperators,
            "support.arduinosupport":arduinoSupport,
            "storage.arduinostorage":arduinoStorage,
            "constant.arduinoconst":arduinoConstant
        }, "identifier");
            ...
            "start" : [
                {
                    ...
                    // regex : /^\/\/{{[0-9a-zA-z_\-\s]*}}/,
                    regex : /^\/\/{{/,
                    stateName:"virtualfile",
                    next: [
                        { token: "string.other", regex: /[0-9a-zA-z_\-\s]*$/,next:"start" },
                        { token: "string.language.escape", regex: /}}/ },
